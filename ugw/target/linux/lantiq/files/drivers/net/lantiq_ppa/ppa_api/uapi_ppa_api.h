#ifndef UAPI__PPA_API_H__20081031_1913__
#define UAPI__PPA_API_H__20081031_1913__
...
/*!
  \brief PPA_UNSUPPORTED_IOCTL
 */
#define PPA_UNSUPPORTED_IOCTL                   -93
...
/*
 * Queue Threshold Color Flags
 */
/** PPA_QOS_COL0_THRESHOLD:Set unassigned Threshold of a queue. */
#define PPA_QOS_COL0_THRESHOLD	0x00000001
/** PPA_QOS_COL1_THRESHOLD:Set Green Threshold of a queue. */
#define PPA_QOS_COL1_THRESHOLD	0x00000002
/** PPA_QOS_COL2_THRESHOLD:Set Yellow Threshold of a queue. */
#define PPA_QOS_COL2_THRESHOLD	0x00000004
/** PPA_QOS_COL3_THRESHOLD:Set Red Threshold of a queue. */
#define PPA_QOS_COL3_THRESHOLD	0x00000008
...
#define SESSION_FLAG2_VALID_IPSEC_TRANS	       0x00001000
#define SESSION_FLAG2_VALID_ESP_INC_NTC        0x00002000
...
#if defined(CONFIG_LTQ_PPA_GRX500) && CONFIG_LTQ_PPA_GRX500
typedef GSW_PCE_pattern_t ppa_class_pattern_t; 		/*!< PPA class pattern */ //Include gsw_glow.h
#endif
...
} PPA_CLASS_RULE; /*This structure should be generic as the corresponding IOCTL call can be triggered from any platform not only GRX500. Clean this up*/
...
/*!
  \brief QoS Queue Threshold configuration structure
 */
typedef struct {
	/** Queue Enable */
	uint32_t qe;
	/*!< Name of Interface*/
	PPA_IFNAME ifname[PPA_IF_NAME_SIZE];
	/*!< Flags Specifying Color*/
	uint32_t col_flag;
	 /*!< Queue num of a queue*/
	uint32_t queue_num;
	/*!< QID of Queue*/
	uint32_t qid;
...
typedef struct {
    ...
    int32_t                 flags; /*!< Drop flags - Drop for red color, yellow color, red color */
...
typedef enum {
	...
	PPA_CMD_SET_QOS_METER_NR,
	PPA_CMD_SET_QOS_QUEUE_THR_NR,
...
#define PPA_CMD_SWAP_SESSIONS                _IOWR(PPA_IOC_MAGIC, PPA_CMD_SWAP_SESSIONS_NR, PPA_CMD_SWAP_SESSION)
 ...
 */
#define PPA_CMD_SET_QOS_METER _IOW(PPA_IOC_MAGIC, PPA_CMD_SET_QOS_METER_NR, PPA_QOS_METER_CFG)

/** PPA Set QOS Queue Threshold. Value is manipulated by _IOW() macro for final value
  \param[in] PPA_QOS_QUEUE_THRESHOLD_CFG The parameter points to a
  \ref PPA_QOS_QUEUE_THRESHOLD_CFG structure
 */
#define PPA_CMD_SET_QOS_QUEUE_THR _IOW(PPA_IOC_MAGIC, PPA_CMD_SET_QOS_QUEUE_THR_NR, PPA_QOS_QUEUE_THRESHOLD_CFG)
