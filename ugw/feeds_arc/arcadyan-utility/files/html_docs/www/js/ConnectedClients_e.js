...
Data.prototype = 
{
	...
	showExtenderInfo: function()
	{
	    ...
	    outputString = "<td style='padding-top:5px;padding-bottom:5px;'>"
	        ...
	        + '<div style="position:relative;top:30px;left:0;text-align:right;padding-right:30px;color:#4598aa;font-size:12pt;cursor:pointer;" onClick="extenderGotosettingFn(macAddress)" >Go to Setting<img src="image/gotosettings.png?v=04e7b0f464" alt="" width="23" height="23" style="margin-left:5px;"></div>'
	        + "</div>"
	        + "</div>"
	        + "</td>";
	...
	if(datalist.list.length > 0) {
        ...
        if(obj.Type.indexOf("Extender") > 0 || obj.Type.indexOf("AP") > 0 || obj.Type.indexOf("PowerLine") > 0)
		{
			...
			if((currentIndex + 1) < (datalist.list.length - 2)) {
				extenderItemsHTML = 
				'<img src="image/extender_prev.png?v=80607c822a" alt="" width="23" height="23" style="padding-right: 5px;" onclick="prevExtender('+ (currentIndex+1) +')"/>'
				+ '<label>' + name + '</label>'
				+'<img src="image/extender_next.png?v=20a7628fba" alt="" width="23" height="23" style="padding-left: 5px;" onclick="nextExtender('+ (currentIndex+1) +')"/>';
...
function getExtenderList() 
{
 ...
 //                }
	...
	// 				extenderItemsHTML = 
	// 				//'<img src="image/extender_prev.png?v=80607c822a" alt="" width="23" height="23" onclick="prevExtender()"/>'
	// 				'<label>' + name + '</label>'
	// 				+'<img src="image/extender_next.png?v=20a7628fba" alt="" width="23" height="23" style="padding-left: 5px;" onclick="nextExtender(0)"/>';
	// 			} else {
	// 				extenderItemsHTML = 
	// 				'<label>' + name + '</label>';
	// 			}
