...
function addRowToTable(num, a, b, c, d, e, f, g, h, m) {
	if (IsLoaded) {
		...
		if (f == "Enabled"){
			...
			Input6.setAttribute('src', 'image/download_btn.png?v=78675acce7');
		...
		Input7.setAttribute('src', 'image/edit_btn.png?v=2fc10c4616');
		...
		Input8.setAttribute('src', 'image/trash.png?v=8fee37bb10');
...
function assignRowToIndex(id){
	...
	if (document.getElementById("edit_status_VPN").checked) {
		...
		tbl.rows[id].childNodes[5].innerHTML = '<img src="image/download_btn.png?v=78675acce7" width="28" height="28" style="cursor:pointer;" onclick="downloadData('+ "'" + document.getElementById("edit_UserName").value + "'" + ')" id="'+ DOWNLOAD_ICON + id +'">'; 
	} else {
