var basedImage = new Array('image/bg2.png?v=8efadc6f54', 'image/loading_big.png?v=e43d1b8294', 'image/Infor2.png?v=966b819ac4', 'image/loading.gif?v=9ac0c71dfa');

document.write("<script src='js/AES.js?v=0a8188a843'></script>");
document.write("<script src='js/spin.js?v=1d5d5837bb'></script>");
