...
function addRowToTable(num)
{
	if (IsLoaded)
	{
		...
		Input4.setAttribute('src', 'image/edit_btn.png?v=2fc10c4616');
		...
		Input5.setAttribute('src', 'image/trash.png?v=8fee37bb10');
...
function assignRowToIndex(id)
{
	...
	if (document.getElementById("edit_Folder").value == DefaultDirectory_Path)	{	
		tbl.rows[id].childNodes[1].childNodes[0].innerHTML = I18N("j", "root");								
	}
	else {	
		tbl.rows[id].childNodes[1].childNodes[0].innerHTML = document.getElementById("edit_Folder").value;	
	}
