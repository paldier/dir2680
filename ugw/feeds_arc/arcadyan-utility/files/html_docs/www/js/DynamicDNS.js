...
{
	var tbl = document.getElementById(TABLE_NAME);
	var tmp_editHostName = XMLDecode(tbl.rows[id].childNodes[1].childNodes[0].innerHTML);
...
function assignRowToIndex(id)
{
	...
	var get_EditHostName = XMLEncode(document.getElementById("dnsv6_EditHostName").value);
	//console.log(get_EditHostName)
