...
static void ndisc_recv_na(struct sk_buff *skb)
{
	...
	{
		/* Zhijian 2015-02-07 For the implementation of most Linux OS, the NS packet often doesn't contain the option of link layer address.*/
		lladdr = eth->h_source;
	}
#endif
...
static struct proc_dir_entry *proc_net_fops_create(struct net *net, const char *name, umode_t mode, const struct file_operations *fops)
{
