...
static const unsigned pins_slic[] = {GPIO1, GPIO34, GPIO35, GPIO36};
static const unsigned pins_slic_clkout[] = {GPIO8};
...
//	GRP_MUX("spi0_cs6", SPI0, pins_spi0_cs6),
	...
	GRP_MUX("slic_clkout", CGU, pins_slic_clkout)
};
...
static const char * const xrx500_slic_grps[] = {"slic","slic_clkout"};
...
//	{"spi0",	ARRAY_AND_SIZE(xrx500_spi0_grps)},
    ...
    {"slic",    ARRAY_AND_SIZE(xrx500_slic_grps)}
};
